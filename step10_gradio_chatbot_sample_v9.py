...
def get_random_waiting_image():
    """
    【修正点】待機中用にNormalかThinkingの全画像からランダムに1枚取得
    """
    # ThinkingとDefault(Normal)の画像リストを結合
    candidates = (
...
def respond(message, history):
    ...
    # 【修正点】
    # 生成開始前に、NormalかThinkingの中からランダムに1枚選んで表示
