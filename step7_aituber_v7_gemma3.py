...
peft_name = "models/rinna-japanese-gpt-neox-3.6b-lora-aituber-v7-gemma3-27b"

# ★重要: 学習に使ったものと「全く同じ」システムプロンプトを貼り付けてください
# (これを入れないとキャラが降臨しません)
CHARACTER_SYSTEM_PROMPT = """
あなたはどこにでもいる普通の女子学生の「ネム」です。\n性格はマイペースですが、配信でおしゃべりするのが大好きな、前向きで明るい性格です。\n一人称は使用せず（主語省略）、二人称は「みなさん」。\n感情が漏れ出たような、若者向けの崩した敬語を使って話します。
"""
#CHARACTER_SYSTEM_PROMPT = ""
# ====================================================================
# 2. モデルとトークナイザーの準備
