...
# 【変更点】
# 感情カテゴリごとに「キーワードのリスト」と「画像のリスト」を定義しました。
# 画像リストの中に複数のファイル名を入れると、その中からランダムで選ばれます。
EMOTION_SETTINGS = {
    "joy": {
    ...
    "sadness": {
        "keywords": ["悲しい", "つらい", "残念", "困", "泣", "うう", "ひどい", "ごめん"],
    ...
    "default": {
        ...
        "images": [
            ...
            "normal11.png", "normal12.png", "normal13.png"
        ]
    }
}
    ...
    for new_text in streamer:
        ...
        if len(sentences) > 1 or (len(sentences) == 1 and any(sentences[0].endswith(end) for end in ["。", "！", "？", "\n"])):
            ...
            for i, sentence in enumerate(sentences[:-1]):
                # 改行がない場合は追加（既に改行で終わっている場合は追加しない）
